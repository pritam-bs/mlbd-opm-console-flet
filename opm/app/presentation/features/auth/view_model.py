...
class SplashViewModel:
    def __init__(self):
        ...
        self.get_auth_usecase = application_container.domain.container.get_auth_usecase()
        self.save_auth_usecase = application_container.domain.container.save_auth_usecase()
        self.get_token_usecase = application_container.domain.container.get_token_usecase()
    ...
    def __del__(self):
        logger.debug("SplashViewModel del")

    def validate_input(self, client_name: Optional[str] = None, password: Optional[str] = None):
        current_state: SplashState = self.current_state.mutate(
